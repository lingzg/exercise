...
public class XpdfToText {
	...
	// 转换器的存放位置，默认在E:\PDFBox\xpdf下面
	private String CONVERTOR_STORED_PATH = "E:\\PDFBox\\xpdf\\";
	// 转换器的名称，默认为pdftotext
	...
	public void toTextFile(String targetfile, boolean isLayout) throws IOException {
	...
	private String[] getCmd(File targetfile, boolean isLayout) {
		...
		if (!isLayout)
			layout = "";
		return new String[] { command, layout, encoding, character, mistake, nopagebrk, source_absolutePath,
				target_absolutePath };
	}
